...
describe("[Challenge] The rewarder", function () {
  ...
  it("Exploit", async function () {
    ...
    const Attacker05Factory = await ethers.getContractFactory(
      "Attacker05",
      attacker
    );

    const rewardToken = await this.rewarderPool.rewardToken();
    this.attacker05 = await Attacker05Factory.deploy(
      this.flashLoanPool.address,
    ...
    await this.attacker05.getReward();
  });
